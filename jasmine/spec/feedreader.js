...
$(function() {
    ...
    describe('The menu', function() {
        ...
        beforeEach(function() {
            self.menuIsHidden = $('body').hasClass('menu-hidden');
            self.icon = $('.menu-icon-link');
            spyOn(self.icon, 'click').and.callFake(function() {
                self.menuIsHidden = !self.menuIsHidden;
            });
        });
        ...
        it('is hidden by default', function() {
            expect(self.menuIsHidden).toBe(true);
        });
        ...
        it('is visible on click', function() {
            self.icon.click();
            expect(self.menuIsHidden).toBe(false);
        });

        it('is visible on second click', function() {
            self.icon.click();
            self.icon.click();
            expect(self.menuIsHidden).toBe(true);
        });
    ...
    describe('New Feed Selection', function() {
        ...
        it("feed content has changed", function(done) {
            expect(self.contentHasChanged).toBe(true);
            done();
        });
